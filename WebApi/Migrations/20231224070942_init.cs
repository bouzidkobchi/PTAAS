    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Methodologies", x => x.Name);
                });
            ...
            migrationBuilder.CreateTable(
                name: "ApplicationUserPentrationTest",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationUserPentrationTest", x => new { x.PentestersId, x.TokenTestsId });
                    table.ForeignKey(
                        name: "FK_ApplicationUserPentrationTest_Tests_TokenTestsId",
                        column: x => x.TokenTestsId,
                        principalTable: "Tests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ApplicationUserPentrationTest_Users_PentestersId",
            ...
            migrationBuilder.CreateTable(
                name: "PentrationTestTestingMethodology",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PentrationTestTestingMethodology", x => new { x.MethodologiesName, x.TestsId });
                    table.ForeignKey(
                        name: "FK_PentrationTestTestingMethodology_Methodologies_MethodologiesName",
                        column: x => x.MethodologiesName,
                        principalTable: "Methodologies",
                        principalColumn: "Name",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PentrationTestTestingMethodology_Tests_TestsId",
                        column: x => x.TestsId,
                        principalTable: "Tests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationUserPentrationTest_TokenTestsId",
                table: "ApplicationUserPentrationTest",
                column: "TokenTestsId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PentrationTestTestingMethodology_TestsId",
                table: "PentrationTestTestingMethodology",
                column: "TestsId");
